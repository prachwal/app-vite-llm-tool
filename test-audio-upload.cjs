...
// Node.js 18+ ma wbudowany fetch i FormData
...
async function uploadFile() {
    ...
    const file = new File([fileBuffer], '1718848317_Sample_1.mp3', { type: 'audio/mpeg' });
    ...
    try {
        ...
        console.error('❌ Błąd sieci podczas przesyłania:', error.message);
        throw error;
    }
}
...
async function downloadFile(key) {
    ...
    try {
        ...
        console.error('❌ Błąd sieci podczas pobierania:', error.message);
        throw error;
    }
}
